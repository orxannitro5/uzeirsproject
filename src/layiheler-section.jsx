...
import HelmetProject from "./assets/helmet-projects-image.png";
        ...
        <div className="layiheler-section">
            <div className="layiheler-section-top">
                <div className="layiheler-section-top-content">
                    ...
                    <p className="layiheler-top-content-text"><span className="layiheler-top-content-text-span">Əsas Səhifə</span>&nbsp;&nbsp; > &nbsp; Layiheler</p>
                </div>
            </div>
